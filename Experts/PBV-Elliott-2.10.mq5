...
datetime zzDataTopo[];
int      zzHandle;
input int zzProfundidade = 14; // Profundida das ondas maiores
...
int      zzHandle2;
input int zzProfundidade2 = 2 ; // Profundida das ondas menores
...
double stopLoss = 0;
int deltaStop = 0;
input double deltaStopPercentual = 0.270; // Percentual do Delta Stop

// Pontos para definicção do stopLoss no trailling stop
int input stopLossPontos = 82 ; //Pontos para o StopLoss
