...
int input stopLossPontos = 50 ; //Pontos para o StopLoss

double precoTopoAtual2 = 0;
double precoTopoAnterior2 = 0;
double precoFundoAnterior2 = 0 ;
double precoFundoAtual2 = 0 ;
...
// Trailling stop
   ...
   if( isPosicaoAberta ) {
      ...
      if( buscarPosicaoAbertasByTipo(POSITION_TYPE_BUY) == true ) {
         ...
         Print("Posição de COMPRA em aberto...");

         if( ativoInfo.Last() > precoFundoAnterior2 ) {
            Print("Preço atual é MAIOR do que o precoFundoAnterior2");
         ...
         if( ativoInfo.Last() < precoTopoAnterior2 ) {
            ...
            Print("Preço atual é MAIOR do que o precoTopoAnterior2");
         }
      }
